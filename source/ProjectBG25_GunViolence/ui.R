...
Report <- tabPanel(
  ...
  h2("Discussion"),
  p("Observing gun violence by state brings to question what kind of laws and policies are currently put into place and how do they differ from other states? As a society this information needs to be brought into the eyes to those in the positions of policymakers in order to stop this trend of gun violence as we have seen the negative implications in our society today. The distribution of gun violence deaths through the cities in the US show the cities that are most prone to gun violence. This brings to question what is special about these cities that causes people to feel the need to kill others? What about these cities makes the killers feel okay, feel safe, to kill others? Are there any laws in place to keep these people in check? What can those in power do to help decrease the number of deaths in these cities? If our second chart is sent out into the public, the findings here would be able to provide those in power a narrowed down map of where to zero in on and where to send help to first within each state. The findings here could also be used by the general public as a warning of which cities are more dangerous. They would then be able to avoid these cities as they plan travels or other events which could possibly help to decrease the number of deaths within those cities if people begin to avoid those cities. By looking at the trend of gun violence throughout the years, those in power would be able to see which years had lower gun violence deaths and be able to look back on what was done to cause this to happen. They would then be able to replicate what their predecessors did and possibly lower gun violence deaths. Those in power would also be able to see which state has the greatest increase in gun violence deaths and can then zero in on those specific states to set new rules etc. in attempt to lower the gun violence deaths in those states. Overall, the implications of our findings show that gun violence deaths have increased over the years throughout the US and if nothing is done to prevent it, gun violence deaths would slowly increase and deaths would become more and more common."),
  h2("Conclusions"),
