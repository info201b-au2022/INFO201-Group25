...
```{r chart_5, echo=FALSE}
death_distribution_by_city_in_washington
```

### Gun Violence Distribution by State in 2016

The purpose of the chart below is to provide a visualization comparison of the amount deaths caused by gun violence across different state from 2013 to 2018. According to the chart California and Texas are the states with the most deaths caused by gun violence.
